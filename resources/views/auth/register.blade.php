            ...
            <form action="{{ route('register') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    value="{{ old('username') }}" id="username" name="username"
                        placeholder="Tu Nombre de usuario" type="text" />
                ...
                <div class="mb-5">
                    ...
                    value="{{ old('email') }}"" id="email" name="email"
                        placeholder="Tu Email de Registro" type="email" />
                ...
                <div class="mb-5">
                    ...
                    @enderror" 
                        ...
                        placeholder="Password de Registro" type="password" />
                ...
                <div class="mb-5">
                    ...
                    @enderror" 
                        ...
                        placeholder="Repite tu Password" type="password" />
